...
from .views import homeView, login_view, logout_view, lista_facultades, lista_carreras, registrar_carrera, registrar_facultad, listar_bloques, registrar_bloque, bloques_carrera
from django.conf import settings
from django.conf.urls.static import static

urlpatterns = [
    path('inicio/', homeView, name="page-home"),
    path('', login_view, name="page-login"),
